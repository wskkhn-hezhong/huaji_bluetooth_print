...
LineText _$LineTextFromJson(Map<String, dynamic> json) {
  return LineText(
    ...
    fontWidth: json['fontWidth'] as int?,
    fontHeight: json['fontHeight'] as int?,
    codeHeight: json['codeHeight'] as int?,
...
Map<String, dynamic> _$LineTextToJson(LineText instance) {
  ...
  writeNotNull('fontWidth', instance.fontWidth);
  writeNotNull('fontHeight', instance.fontHeight);
  writeNotNull('codeHeight', instance.codeHeight);
