...
class HuajiBluetoothPrint {
 static const String NAMESPACE = 'bluetooth_print';
  ...
  static HuajiBluetoothPrint _instance = new HuajiBluetoothPrint._();

  static HuajiBluetoothPrint get instance => _instance;
  ...
  Stream<BluetoothDevice> scan({
    ...
    yield* HuajiBluetoothPrint.instance._methodStream
