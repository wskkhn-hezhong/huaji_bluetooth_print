#import "HuajiBluetoothPrintPlugin.h"
...
+ (void)registerWithRegistrar:(NSObject<FlutterPluginRegistrar>*)registrar {
  ...
  HuajiBluetoothPrintPlugin* instance = [[HuajiBluetoothPrintPlugin alloc] init];
...
-(NSData *)mapToTscCommand:(NSDictionary *) args {
    ...
    for(NSDictionary *m in list){
        ...
        NSNumber *fontWidth = ![m objectForKey:@"fontWidth"]?@1 : [m objectForKey:@"fontWidth"];
        NSNumber *fontHeight = ![m objectForKey:@"fontHeight"]?@1 : [m objectForKey:@"fontHeight"];
