...
public class PrintContent {
      ...
      public static Vector<Byte> mapToLabel(Map<String,Object> config, List<Map<String,Object>> list) {
            ...
            for (Map<String,Object> m: list) {
                  ...
                  int fontWidth = (int)(m.get("fontWidth")==null?1:m.get("fontWidth"));
                  int fontHeight = (int)(m.get("fontHeight")==null?1:m.get("fontHeight"));
                  int codeHeight = (int)(m.get("codeHeight")==null?40:m.get("codeHeight"));

                  if("text".equals(type)){
                        // 绘制简体中文
                        if(fontWidth == 2 && fontHeight == 2){
                              tsc.addText(x, y, LabelCommand.FONTTYPE.SIMPLIFIED_CHINESE, LabelCommand.ROTATION.ROTATION_0, LabelCommand.FONTMUL.MUL_2,LabelCommand.FONTMUL.MUL_2, content);
                        }else if(fontWidth == 1 && fontHeight == 2){
                              tsc.addText(x, y, LabelCommand.FONTTYPE.SIMPLIFIED_CHINESE, LabelCommand.ROTATION.ROTATION_0, LabelCommand.FONTMUL.MUL_1,LabelCommand.FONTMUL.MUL_2, content);
                        }else if(fontWidth == 2 && fontHeight == 1){
                               tsc.addText(x, y, LabelCommand.FONTTYPE.SIMPLIFIED_CHINESE, LabelCommand.ROTATION.ROTATION_0, LabelCommand.FONTMUL.MUL_2,LabelCommand.FONTMUL.MUL_2, content);
                        }else {
                        ...
                        tsc.add1DBarcode(x, y, LabelCommand.BARCODETYPE.CODE128, codeHeight, LabelCommand.READABEL.EANBEL, LabelCommand.ROTATION.ROTATION_0, content);
                  }else if("qrcode".equals(type)){
