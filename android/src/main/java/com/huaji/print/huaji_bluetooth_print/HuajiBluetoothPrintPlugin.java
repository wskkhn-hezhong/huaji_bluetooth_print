...
/** HuajiBluetoothPrintPlugin */
public class HuajiBluetoothPrintPlugin implements FlutterPlugin, ActivityAware, MethodCallHandler, RequestPermissionsResultListener {
  ...
  public static void registerWith(Registrar registrar) {
    final HuajiBluetoothPrintPlugin instance = new HuajiBluetoothPrintPlugin();
  ...
  public HuajiBluetoothPrintPlugin(){
  }
